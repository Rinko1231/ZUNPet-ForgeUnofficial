...
public abstract class AbstractItemInstrument extends Item {
    ...
    public void playSound(Level level, Player player) {
        ...
        Vec3i pos = new Vec3i((int) player.position().x, (int) player.position().y, (int) player.position().z);
        level.playSound(player, new BlockPos(pos), getSound(), SoundSource.PLAYERS, 2, pitch);
    }
