...
public class zunpetSoundEvents {
   ...
   public static final RegistryObject<SoundEvent> ZUNPET_SOUND = SOUND_EVENTS.register("zunpet", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(Zunpet.MOD_ID, "zunpet")));
